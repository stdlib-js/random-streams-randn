...
```javascript
import randomStream from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-randn@v0.2.2-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/random-streams-randn/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/random-streams-randn/actions/workflows/test.yml?query=branch:v0.2.2
